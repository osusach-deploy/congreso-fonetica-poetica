...
<div class="block lg:hidden z-20">
    ...
    <div class="absolute gap-2 top-[96px] left-0 right-0 w-[100%] bg-slate-600 pt-1 pb-2 text-white text-lg divide-y divide-slate-500 {showMenu ? 'flex flex-col' : 'hidden'}">
