<article class="mx-10 sm:w-[65%] text-xl mb-20 gap-y-4 flex flex-col">
  ...
  <ul>
    ...
    <li>
      Es recomendable usar alguna presentación y recomendamos letra de tamaño
      legible y texto fundamental.
    </li>
    <li>Considerar que la plataforma de presentación será Zoom.</li>
  </ul>

  <p>La fecha del congreso: 14 y 15 de noviembre de 2024 desde las …</p>

  <p>Se recuerda que las áreas temáticas son las siguientes</p>
