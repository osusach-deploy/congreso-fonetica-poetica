...
>
  ...
  <div class="flex flex-col flex-wrap md:flex-row items-center justify-center gap-10 lg:gap-14">
    <img src="/img/fonetica.png" class="h-36 bg-white rounded-full" alt="" />
    <img src="/img/conce.png" class="h-16" alt="" />
    <img src="/img/granada.png" class="h-16" alt="" />
    <img src="/img/eu.png" class="h-16" alt="" />
    <img src="/img/vhp.png" class="h-20" alt="" />
  </div>
</div>
