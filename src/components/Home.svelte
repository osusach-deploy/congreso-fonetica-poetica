...
<div class="flex flex-col w-full items-center mt-20">
  <div
    class=" animate-fade-up animate-ease-in-out flex flex-row my-10 w-[60%] justify-between"
  >
    <div
      class="flex flex-col w-[40%] gap-3 text-center align-middle justify-center"
    >
      <p class=" font-light text-5xl">
        1er CONGRESO NACIONAL DE FONÉTICA Y POÉTICA
      </p>
    ...
    >
      ...
      >
        ...
        <button
          type="submit"
          class="flex w-[30%] justify-center bg-indigo-400 hover:bg-indigo-500 transition-all text-white font-semibold py-2 px-4 rounded-r-full"
          >Suscribirse</button
        >
      </form>
    </div>
